        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div class="bg-white p-6 sm:p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 sm:ml-5">
                        <div class="text-2xl sm:text-3xl font-bold text-gray-900"><?php echo e($totalJobs); ?></div>
            ...
            <div class="bg-white p-6 sm:p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 sm:ml-5">
                        <div class="text-2xl sm:text-3xl font-bold text-gray-900"><?php echo e($totalCompanies); ?></div>
            ...
            <div class="bg-white p-6 sm:p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 sm:ml-5">
                        <div class="text-2xl sm:text-3xl font-bold text-gray-900"><?php echo e($totalUsers); ?></div>
    ...
    <div class="max-w-7xl mx-auto py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            <?php $__currentLoopData = $featuredJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($job->status === 'active' && $job->company && $job->company->status === 'approved'): ?>
                        ...
                        <div class="p-5 sm:p-6 flex-grow">
                            ...
                            <div class="mt-4 grid grid-cols-1 gap-2 sm:gap-3">
                                ...
                                <div class="flex items-center text-xs sm:text-sm text-gray-500">
                                    ...
                                    <span class="truncate"><?php echo e($job->employment_type); ?></span>
                                </div>
                                <div class="flex items-center text-xs sm:text-sm text-gray-500">
                                    <i class="fas fa-user-graduate text-gray-400 w-4 text-center mr-2"></i>
                                    <span class="truncate"><?php echo e($job->experience_level ?: 'Not specified'); ?></span>
                                </div>
                            </div>
                            ...
                            <?php if($job->salary_range): ?>
                                <div class="mt-4 flex items-center justify-between bg-gray-50 rounded-lg px-3 py-2 sm:px-4 sm:py-3">
                                    <div class="flex items-center text-xs sm:text-sm">
                                        ...
                                        <span class="font-medium text-gray-900"><?php echo e($job->salary_range); ?></span>
                                    </div>
                                    <?php if($job->salary_is_negotiable): ?>
                        ...
                        <div class="bg-gray-50 px-5 sm:px-6 py-3 sm:py-4 border-t border-gray-100 mt-auto">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                <div class="flex items-center space-x-3 sm:space-x-4">
                                    ...
                                    <?php if($job->applications_count): ?>
                                        <div class="flex items-center text-xs sm:text-sm text-gray-500">
                                            <i class="fas fa-users mr-1 sm:mr-1.5"></i>
                                            <?php echo e($job->applications_count); ?> <?php echo e(Str::plural('applicant', $job->applications_count)); ?>
    ...
    <div class="max-w-7xl mx-auto py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 sm:gap-6">
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('search.index', ['type' => 'jobs', 'department' => $category->department])); ?>"
                   class="group bg-white p-5 sm:p-6 lg:p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="flex items-center justify-between mb-3 sm:mb-4">
                        <div class="h-12 w-12 sm:h-14 sm:w-14 bg-indigo-100 rounded-lg flex items-center justify-center group-hover:bg-indigo-200 transition-colors duration-200">
                            <?php if($category->icon): ?>
                                <i class="<?php echo e($category->icon); ?> text-xl sm:text-2xl text-indigo-600"></i>
                            <?php else: ?>
                                <i class="fas <?php echo e(match($category->department) {
                    ...
                    <p class="mt-1.5 sm:mt-2 text-xs sm:text-sm text-gray-500">Browse all <?php echo e($category->department); ?> jobs</p>
                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
                        ...
                        <div class="text-center">
                            ...
                            <div class="mt-2 flex flex-col sm:flex-row items-center justify-center space-y-1 sm:space-y-0 sm:space-x-3 text-xs sm:text-sm text-gray-500">
                                <span class="flex items-center">
                                    ...
                                    <?php echo e($company->job_postings_count); ?> <?php echo e(Str::plural('job', $company->job_postings_count)); ?>

                                </span>
                                <?php if($company->headquarters): ?>
                                    <span class="flex items-center">
                                        <i class="fas fa-map-marker-alt mr-1 sm:mr-1.5"></i>
                                        <?php echo e($company->headquarters); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PHP_BACKEND_JOB_2_DAY\resources\views/home.blade.php ENDPATH**/ ?>