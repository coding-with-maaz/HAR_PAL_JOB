...
<div class="bg-white">
    ...
    <div class="bg-indigo-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <form action="<?php echo e(route('search.index')); ?>" method="GET" class="mt-8">
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                    ...
                    <div class="md:col-span-2">
                        <select name="type" 
                            ...
                            <option value="jobs" <?php echo e($type === 'jobs' ? 'selected' : ''); ?>>Jobs</option>
                            <option value="companies" <?php echo e($type === 'companies' ? 'selected' : ''); ?>>Companies</option>
                        </select>
                    </div>
                    ...
                    <div class="md:col-span-2 <?php echo e($type !== 'companies' ? '' : 'hidden'); ?>">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <!-- Categories Section -->
        <?php if(isset($categories) && $categories->isNotEmpty() && ($type === 'all' || $type === 'jobs')): ?>
            <div class="mb-8">
        ...
        <!-- Active Filters -->
        <?php if(request()->anyFilled(['search', 'location', 'employment_type', 'remote', 'posted_today', 'easy_apply', 'industry'])): ?>
            <div class="mb-6">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <?php if(request('industry')): ?>
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-indigo-100 text-indigo-800">
                            ...
                            <a href="<?php echo e(request()->except('industry')); ?>" class="ml-2 text-indigo-600 hover:text-indigo-500">
                                <i class="fas fa-times"></i>
                            </a>
                        </span>
                    <?php endif; ?>
        ...
        <div class="mb-6 flex items-center justify-between">
            <h2 class="text-xl font-semibold text-gray-900">
                <?php if($type === 'all'): ?>
                    <?php echo e($jobs->total() + $companies->total()); ?> Results Found
                <?php elseif($type === 'jobs'): ?>
                    <?php echo e($jobs->total()); ?> Jobs Found
                <?php else: ?>
                    <?php echo e($companies->total()); ?> Companies Found
                <?php endif; ?>
            </h2>
            <?php if($type !== 'companies'): ?>
                <div class="flex items-center">
        ...
        <!-- Company Results -->
        <?php if($type === 'all' || $type === 'companies'): ?>
            <div class="space-y-6 <?php echo e($type === 'all' && $jobs->isNotEmpty() ? 'mt-12' : ''); ?>">
                <?php if($type === 'all' && $jobs->isNotEmpty()): ?>
                    ...
                    <div class="bg-white shadow rounded-lg p-6 hover:shadow-lg transition-shadow duration-200">
                        <div class="flex items-start">
                            ...
                            <div class="ml-6 flex-1">
                                <div class="flex items-center justify-between">
                                    <h3 class="text-xl font-semibold text-gray-900">
                                        <a href="<?php echo e(route('companies.show', $company)); ?>" class="hover:text-indigo-600">
                                            <?php echo e($company->name); ?>

                                        </a>
                                    </h3>
                                    <span class="text-sm text-gray-500">
                                        <?php echo e($company->job_postings_count); ?> active jobs
                                    </span>
                                </div>
                                ...
                                <?php if($company->description): ?>
                                    <p class="mt-4 text-gray-600">
                                        <?php echo e(Str::limit($company->description, 200)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PHP_BACKEND_JOB_2_DAY\resources\views/search/index.blade.php ENDPATH**/ ?>