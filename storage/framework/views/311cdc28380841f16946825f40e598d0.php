...
<div class="container mx-auto px-4 py-8 max-w-6xl">
    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <form action="<?php echo e(route('admin.jobs.store')); ?>" method="POST" class="p-6 space-y-8">
            <?php echo csrf_field(); ?>
                ...
                <div class="mb-6">
                    ...
                    <div class="mt-2">
                        <textarea name="description" id="description" rows="4" required
                            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"><?php echo e(old('description')); ?></textarea>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="mt-2">
                        <textarea name="requirements" id="requirements" rows="3"
                            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            placeholder="e.g., 5+ years experience, Bachelor's degree, Strong communication skills"><?php echo e(old('requirements')); ?></textarea>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="mt-2">
                        <textarea name="responsibilities" id="responsibilities" rows="4" required
                            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"><?php echo e(old('responsibilities')); ?></textarea>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="mt-2">
                        <textarea name="skills_required" id="skills_required" rows="3" required
                            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            placeholder="e.g., PHP, Laravel, MySQL, JavaScript"><?php echo e(old('skills_required')); ?></textarea>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <textarea name="benefits" id="benefits" rows="3" required
                            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            placeholder="e.g., Health insurance, 401(k), Flexible hours"><?php echo e(old('benefits')); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                <button type="button" onclick="window.location.href='<?php echo e(route('admin.jobs.index')); ?>'"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PHP_BACKEND_JOB_2_DAY\resources\views/admin/jobs/create.blade.php ENDPATH**/ ?>