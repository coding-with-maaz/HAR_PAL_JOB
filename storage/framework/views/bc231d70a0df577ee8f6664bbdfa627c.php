    ...
    <div class="bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
            ...
            <div class="mt-8 max-w-3xl mx-auto bg-white rounded-lg shadow-xl p-6 sm:p-8">
                <form action="<?php echo e(route('search.index')); ?>" method="GET" class="space-y-4">
                   ...
                   class="group bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden flex flex-col p-6 hover:border-indigo-300 border border-transparent">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-indigo-100 text-indigo-800">
                            <?php echo e($category->job_count); ?> <?php echo e(Str::plural('job', $category->job_count)); ?>

                        </span>
                    </div>
                    <h3 class="text-lg font-semibold text-gray-900 mb-1 group-hover:text-indigo-600 transition-colors duration-200 flex-grow"><?php echo e($category->department); ?></h3>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PHP_BACKEND_JOB_2_DAY\resources\views/categories/index.blade.php ENDPATH**/ ?>