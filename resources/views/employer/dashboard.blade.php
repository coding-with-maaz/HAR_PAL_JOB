    ...
    @if($company && $company->status === 'approved')
        ...
        <div class="bg-white rounded-lg shadow mb-8">
            <div class="p-6 border-b border-gray-200">
                <div class="flex justify-between items-center">
                    ...
                    <a href="{{ route('employer.company.edit', $company) }}" class="text-indigo-600 hover:text-indigo-900">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">{{ $company->description }}</p>
                        <div class="mt-4">
                    ...
                    <div>
                        <dl class="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900">{{ $company->headquarters }}</dd>
                            </div>
                        </dl>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="mt-2">
                    <a href="{{ route('employer.jobs.index') }}" class="text-sm text-indigo-600 hover:text-indigo-900">View all jobs →</a>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="mt-2">
                    <a href="{{ route('employer.jobs.create') }}" class="text-sm text-green-600 hover:text-green-900">Post new job →</a>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="mt-2">
                    <a href="{{ route('employer.applications.index') }}" class="text-sm text-blue-600 hover:text-blue-900">View all applications →</a>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="mt-2">
                    <a href="{{ route('employer.applications.index', ['status' => 'pending']) }}" class="text-sm text-yellow-600 hover:text-yellow-900">Review applications →</a>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow mb-8">
            <div class="p-6 border-b border-gray-200">
                <div class="flex justify-between items-center">
                    ...
                    <a href="{{ route('employer.jobs.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                        Post New Job
                    </a>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                                ...
                                                @elseif($application->status === 'interviewed') bg-blue-100 text-blue-800
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <a href="{{ route('employer.applications.show', $application) }}" class="text-indigo-600 hover:text-indigo-900">View</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
